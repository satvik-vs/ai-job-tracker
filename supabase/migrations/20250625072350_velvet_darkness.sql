/*
  # Add Resume Content Field to Documents Table

  1. Changes
    - Add resume_content column to documents table
    - This allows storing the extracted text content from resume files
    - Enables AI analysis without needing to re-extract content
